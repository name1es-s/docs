...
- 1.8 Правила могут быть дополнены. О всех дополнения будет сообщено в [информационных](https://discord.com/channels/874214350469087264/875280535583326208) каналах.
...
- 3.9 Если ваша будущая постройка/арт и т.д. может быть спорной и нарушать действующие правила, обратитесь к модерации для решения вопроса;



# 4. Правила поведения на общественной территории
- 4.1 Территория <Tooltip text="спавна" tooltipText="2.1 Спавн - стандартное место появления всех игроков в верхнем мире. Место появления игрока на иных координатах, связанное со снижением нагрузки на сервер, не является спавном. Область, прописанная в пункте 4.1, является общественной территорией." /> и <Tooltip text="хаба" tooltipText="Хаб - нулевые координаты в аду и область, прописанная в пункте 4.1, является общественной территорией" /> ограничена 400x400 (радиус 200) и 250x250 (радиус 125) блоков соответственно. В данной области реализуются проекты спавна/хаба/веток, предложенные инициативной группой игроков. Актуальные проекты представлены в дискорде в канале [“проекты”](https://discord.com/channels/874214350469087264/1173923317024051251). Свои идеи проектов вы можете опубликовать там же. В случае, если инициативная группа не находится, то судьба спавна решается посредством голосования. Чистоту проведения голосования регулирует модерация.
...
- 6.2 При создании <Tooltip text="тикета" tooltipText="Тикет - форма обращения к модераторам, реализуемая через дискорд" /> обязательно максимально подробно опишите вашу проблему. Укажите все детали, которые могут помочь модераторам быстро понять суть вашего вопроса или жалобы.
- 6.3 На запросы, направленные напрямую на сервере, модератор может ответить на свое усмотрение.
...
- 6.6 Каждый игрок имеет право оспорить решение модератора, привлечь других модераторов к обсуждению спорного вопроса и перепроверке;


# 7. Наказания и их обозначение
- 7.1 Есть такие виды наказаний:
  ...
  - Варн - игрок получает предупреждение, которое фиксируется в его истории нарушений. Накопление трех варнов приведет к бану.
...
- 2.1 Спавн - стандартное место появления всех игроков в верхнем мире. Место появления игрока на иных координатах, связанное со снижением нагрузки на сервер, не является спавном. Область, прописанная в пункте 4.1, является общественной территорией.
- 2.3 Хаб - нулевые координаты в аду и область, прописанная в пункте 4.1, является общественной территорией.
