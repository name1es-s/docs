...
- 3.9 Мап-арты разрешены к постройке в специально предназначенном для этого мире. Размещение мап-артов в Верхнем мире строго запрещено.
...
- 4.4 Запрещено на территории спавна  использование рамок и светящихся табличек, а также <Tooltip text="кастомных стоек для брони." tooltipText="Кастомные стойки для брони - сделаны при помощи плагина ArmorStandEditor" />. <Tooltip text="Исключения" tooltipText="Арты и декор в разумных пределах" />
